 ...
 * @return [ Void ]
 */
exports.isBatterySupported = function(cb) {
    if (this._isAndroid) {
        cordova.exec(cb, null, 'BackgroundModeExt', 'batterysupported', []);
    } else {
        cb(false);
    }
};
 ...
 * @return [ Void ]
 */
exports.isBatteryIgnored = function(cb) {
    if (this._isAndroid) {
        cordova.exec(cb, null, 'BackgroundModeExt', 'batteryignored', []);
    } else {
        cb(false);
    }
};
...
/**
 * A function for listening to UI Config changes
 *
 * @return [ Void ]
 */
exports.uiChanges = function(cb) {
    if (this._isAndroid) {
        cordova.exec(cb, null, 'BackgroundModeExt', 'uichanges', []);
    }
};
...
/**
 * Async method for if the mode is active for WKWebview accuracy.
 *
 * @return [ Void ]
 */
exports.isActiveAsync = function(cb) {
    if (this._isAndroid) {
        cb(this.isActive());
        return;
    }

    cordova.exec(cb, null, 'BackgroundMode', 'isActive', []);
};
